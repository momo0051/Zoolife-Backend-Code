...
th, td, div, p {-webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; font-size: 13px; line-height: 23px;}
        ...
        <tr>
            <td style="padding: 30px 0;">
                ...
                <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0">
                    ...
                    <tr valign="top" style="vertical-align: top;">
                        <th class="column" width="640" style="padding-left: 30px; padding-right: 30px;">
                            <center>
                                <a href="http://www.e.zone" target="_blank">
                                    <img src="{{ asset('logo.png') }}" width="130" style="border: 0; width: 100%; max-width: 130px;">
                                </a>
                            </center>
                        </th>
                    </tr>
                ...
                <table class="row" align="center" bgcolor="#F4F4F4" cellpadding="0">
                    ...
                    <tr valign="top" style="vertical-align: top;">
                        <th width="520" align="left" class="column mobile-12" style="padding: 0 90px; color: #232323; font-weight: 400;">

                            <div style="font-size: 28px; font-weight: 700; line-height: 30px; margin-bottom: 30px;">Hello, </div>
                            <div style="color: #666666; font-size: 18px; margin-bottom: 45px;">
                            ...
                            <div style="display:none; color: #666666; font-size: 18px; margin-bottom: 45px;">
                               Deal : Hello<br/>
                               Deal Ref : Hello<br/>
                                
                                Reason :Hello <br/>
                                
                                Link :<a href="#">Hello Demo</a><br/>
                                
                                <br/>

                           </div>

                           <div style="font-size: 14px; margin-top: 45px;">Thanks, <br><strong>Solar Sales Team</strong></div>
                       </th>
                   </tr>
                   <tr>
                    <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
